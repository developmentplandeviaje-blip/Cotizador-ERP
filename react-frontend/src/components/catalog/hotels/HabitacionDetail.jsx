        ...
        <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'left', fontSize: '0.875rem' }}>
          <thead>
            <tr style={{ background: '#e8721726', borderBottom: '1px solid rgba(255, 255, 255, 0.84)' }}>
              <th style={{ padding: '14px 20px', color: '#ffffffff', fontWeight: '600' }}>Posición</th>
              <th style={{ padding: '14px 20px', color: '#ffffffff', fontWeight: '600' }}>Habitación</th>
              <th style={{ padding: '14px 20px', color: '#ffffffff', fontWeight: '600' }}>Cotizador</th>
                        ...
                        <td colSpan="5" style={{ padding: '0 20px 20px 20px', background: 'rgba(50, 58, 76, 0.4)' }}>
                          <div style={{
                            ...
                            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.75rem', textAlign: 'left' }}>
                              <thead>
                                <tr style={{ borderBottom: '1px solid rgba(69, 97, 172, 0.46)', color: '#b9c8ddff' }}>
