...
$request = Illuminate\Http\Request::create("/api/v1/catalog/hoteles/{$hotel->id}", "PUT", [], [], [], ["CONTENT_TYPE" => "application/json"], json_encode([
    "habitaciones" => [
        [
            "id" => $room->id,
            "habitacion" => "Doble",
...
$controller->update($formRequest, $hotel);
